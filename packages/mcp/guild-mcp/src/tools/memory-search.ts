...
export const searchMemoriesTool = {
  ...
  description:
    "Cross-tier keyword search across all accessible memory tiers. V1 uses keyword matching; V2 will add vector similarity.",
  inputSchema: {
...
export async function handleSearchMemories(
  ...
  const tiers = input.tiers ?? (["agent", "user", "role", "company"] as const);
