...
export const searchKnowledgeTool = {
    ...
    description: "Semantic similarity search across embedded knowledge chunks. Supports filtering by client, data type, category, product, error code, and tags.",
    inputSchema: {
        type: "object",
        properties: {
...
export async function handleSearchKnowledge(db, args) {
